							...
							<div class="items">
								<ul>
									<#list itemImages as image>
										...
										<li><img src="${image.url}" bimg="${image.url}" " /></li>
									</#list>
								</ul>
							</div>
							<a class="next">&gt;</a>
					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl>
								...
								<#--class="selected"-->
									<dd><a href="javascript:;" class="{{isSelectSpec('${specification.attributeName}','${value}')?'selected':''}}" ng-click="selectSpecification('${specification.attributeName}','${value}')">${value}<span title="点击取消选择">&nbsp;</span></a></dd>
								</#list>
							</dl>
							</#list>
						</div>

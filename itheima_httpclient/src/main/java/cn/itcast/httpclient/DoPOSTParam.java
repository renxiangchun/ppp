...
public class DoPOSTParam {
    ...
    public static void main(String[] args) throws Exception {
        ...
        HttpPost httpPost = new HttpPost("http://localhost:8090/sms/sendSms");

        // 设置2个post参数，一个是scope、一个是q
        List<NameValuePair> parameters = new ArrayList<NameValuePair>(0);
        parameters.add(new BasicNameValuePair("phone_number", "13432043340"));//3 4 4
        parameters.add(new BasicNameValuePair("sign_name", "品优购商城"));
        parameters.add(new BasicNameValuePair("template_code", "SMS_145910485"));
        Map m = new HashMap();
        m.put("code","666666");
